/*
||
|| @file 	TimedAction.cpp -renamed for GoProRC to TimedTask
|| @version	1.7
|| @author	Alexander Brevig
|| @contact	alexanderbrevig@gmail.com
|| @update	Sebastian Balzer
||
|| @description
...
/*
|| @changelog
|| | 1.7 2019-12-09 - Sebastian Balzer : millis() overflow fixed, issue with Arduino V1.8.9 fixed, bool isActive() added
